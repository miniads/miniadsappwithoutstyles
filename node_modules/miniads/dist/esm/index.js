...
var TgAdsContainer = function (props) {
    ...
    var currentAdContent = useMemo(function () {
        ...
        if (currentAdData.adtype === "banner") {
            ...
            return (React__default.createElement(BannerAd, { title: currentAdData.title, text: currentAdData.text, link: currentAdData.link, className: className, onClick: handleAdClick, onClose: handleAdClose, imageLink: currentAdData.iconLink, onError: handleError }));
        }
        if (typeof window !== "undefined") {
            var body = {
                platform: window.location.origin,
