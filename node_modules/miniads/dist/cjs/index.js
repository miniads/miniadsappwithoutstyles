...
var Container = styled.span(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  &::after {\n    content: '';\n    box-sizing: border-box;\n    width: 34px;\n    height: 34px;\n    position: absolute;\n    top: calc(50% - 20px);\n    left: calc(50% - 20px);\n    border: 4px solid var(--tg-theme-secondary-bg-color);\n    border-top-color: var(--tg-theme-button-color);\n    border-radius: 50%;\n    border-width: 2px;\n    animation: rotation 1s linear infinite;\n    @keyframes rotation {\n      0% {\n        transform: rotate(0deg);\n      }\n      100% {\n        transform: rotate(359deg);\n      }\n    }\n  }\n"], ["\n  &::after {\n    content: '';\n    box-sizing: border-box;\n    width: 34px;\n    height: 34px;\n    position: absolute;\n    top: calc(50% - 20px);\n    left: calc(50% - 20px);\n    border: 4px solid var(--tg-theme-secondary-bg-color);\n    border-top-color: var(--tg-theme-button-color);\n    border-radius: 50%;\n    border-width: 2px;\n    animation: rotation 1s linear infinite;\n    @keyframes rotation {\n      0% {\n        transform: rotate(0deg);\n      }\n      100% {\n        transform: rotate(359deg);\n      }\n    }\n  }\n"])));
...
var AdTag$1 = styled.div(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  width: 23px;\n  height: 16px;\n  padding: 2px 4px 1px 4px;\n  border-radius: 6px;\n  gap: 10px;\n  background: #FF9500;\n  font-size: 11px;\n  font-weight: 510;\n  line-height: 13px;\n  letter-spacing: 0.05999999865889549px;\n  text-align: left;\n  display: flex;\n  justify-content: center;\n  color: #FFFFFF;\n"], ["\n  width: 23px;\n  height: 16px;\n  padding: 2px 4px 1px 4px;\n  border-radius: 6px;\n  gap: 10px;\n  background: #FF9500;\n  font-size: 11px;\n  font-weight: 510;\n  line-height: 13px;\n  letter-spacing: 0.05999999865889549px;\n  text-align: left;\n  display: flex;\n  justify-content: center;\n  color: #FFFFFF;\n"])));
var TopInfoWrapper = styled.div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  width: 306px;\n  display: flex;\n  flex-direction: row;\n  gap: 6px;\n"], ["\n  width: 306px;\n  display: flex;\n  flex-direction: row;\n  gap: 6px;\n"])));
var TopWrapper = styled.div(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  width: 100%;\n  padding: 12px;\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  margin-left: auto;\n  margin-right: auto;\n  align-items: center;\n  gap: 10px;\n"], ["\n  position: absolute;\n  top: 0;\n  width: 100%;\n  padding: 12px;\n  display: flex;\n  flex-direction: row;\n  justify-content: flex-start;\n  margin-left: auto;\n  margin-right: auto;\n  align-items: center;\n  gap: 10px;\n"])));
var TopButton$1 = styled.button(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  border-radius: 50%;\n  padding: 0;\n  min-width: 28px;\n  min-height: 28px;\n  width: 28px;\n  height: 28px;\n  margin-left: auto;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border: none;\n  outline: none;\n  background-color: var(--tg-theme-bg-color);\n  fill: var(--tg-theme-text-color);\n  cursor: ", ";\n"], ["\n  border-radius: 50%;\n  padding: 0;\n  min-width: 28px;\n  min-height: 28px;\n  width: 28px;\n  height: 28px;\n  margin-left: auto;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border: none;\n  outline: none;\n  background-color: var(--tg-theme-bg-color);\n  fill: var(--tg-theme-text-color);\n  cursor: ", ";\n"])), function (_a) {
    var disabled = _a.disabled;
    return (disabled ? "not-allowed" : "pointer");
});
var Text$1 = styled.p(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  margin: 0;\n  color: var(--tg-theme-text-color);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  font-size: 16px;\n  line-height: 17px;\n  font-weight: 510;\n  letter-spacing: -0.3100000023841858px;\n  text-align: left;\n"], ["\n  margin: 0;\n  color: var(--tg-theme-text-color);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  font-size: 16px;\n  line-height: 17px;\n  font-weight: 510;\n  letter-spacing: -0.3100000023841858px;\n  text-align: left;\n"])));
styled.a(templateObject_7$1 || (templateObject_7$1 = __makeTemplateObject(["\n  text-decoration: none;\n"], ["\n  text-decoration: none;\n"])));
var VideoBlock = styled.video(templateObject_8$1 || (templateObject_8$1 = __makeTemplateObject(["\n  max-width: 100vw;\n"], ["\n  max-width: 100vw;\n"])));
var MuteIcom = styled(Memo$2)(templateObject_9$1 || (templateObject_9$1 = __makeTemplateObject(["\n  fill: var(--tg-theme-text-color);\n  min-width: 16px;\n"], ["\n  fill: var(--tg-theme-text-color);\n  min-width: 16px;\n"])));
var UnMuteIcom = styled(Memo$3)(templateObject_10$1 || (templateObject_10$1 = __makeTemplateObject(["\n  fill: var(--tg-theme-text-color);\n  min-width: 16px;\n"], ["\n  fill: var(--tg-theme-text-color);\n  min-width: 16px;\n"])));
styled(Memo)(templateObject_11$1 || (templateObject_11$1 = __makeTemplateObject(["\n  fill: var(--tg-theme-text-color);\n  min-width: 16px;\n"], ["\n  fill: var(--tg-theme-text-color);\n  min-width: 16px;\n"])));
...
var templateObject_1$2, templateObject_2$2, templateObject_3$1, templateObject_4$1, templateObject_5$1, templateObject_6$1, templateObject_7$1, templateObject_8$1, templateObject_9$1, templateObject_10$1, templateObject_11$1;

var Placeholder = styled.div(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n    background-color: var(--tg-theme-text-color);\n    opacity: 1;\n    display: block;\n    transition: opacity .2s var(--tg-theme-bg-color);\n    box-shadow: inset 0 0 0 2px var(--tg-theme-button-color);\n    border-radius: 12px;\n"], ["\n    background-color: var(--tg-theme-text-color);\n    opacity: 1;\n    display: block;\n    transition: opacity .2s var(--tg-theme-bg-color);\n    box-shadow: inset 0 0 0 2px var(--tg-theme-button-color);\n    border-radius: 12px;\n"])));
var AdvertisementImage = styled.img(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  border-radius: 12px;\n"], ["\n  border-radius: 12px;\n"])));
...
var LinkWrapper = styled.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  width: 89px;\n  height: 30px;\n  background-color: var(--tg-theme-button-color);\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  border-radius: 24px;\n  cursor: pointer;\n  margin-top: auto;\n  margin-bottom: auto;\n  margin-right: 6px;\n"], ["\n  width: 89px;\n  height: 30px;\n  background-color: var(--tg-theme-button-color);\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  border-radius: 24px;\n  cursor: pointer;\n  margin-top: auto;\n  margin-bottom: auto;\n  margin-right: 6px;\n"])));
...
var CloseBtn = styled.h1(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  font-size: 16px;\n  font-weight: 510;\n  text-align: center;\n  @media only screen and (max-width: 1200px) and (min-width: 768px) {\n  display: list-item;\n  min-height: inherit;\n}\n"], ["\n  font-size: 16px;\n  font-weight: 510;\n  text-align: center;\n  @media only screen and (max-width: 1200px) and (min-width: 768px) {\n  display: list-item;\n  min-height: inherit;\n}\n"])));
var Link = styled.a(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  font-size: 15px;\n  color: var(--tg-theme-button-text-color);\n  line-height: 18px;\n  font-weight: 590;\n  letter-spacing: -0.23px;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n"], ["\n  font-size: 15px;\n  color: var(--tg-theme-button-text-color);\n  line-height: 18px;\n  font-weight: 590;\n  letter-spacing: -0.23px;\n  display: flex;\n  align-items: center;\n  gap: 4px;\n"])));
styled.h1(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  font-size: 16px;\n  font-weight: 400;\n  letter-spacing: -0.4599999785423279px;\n  text-align: center;\n"], ["\n  font-size: 16px;\n  font-weight: 400;\n  letter-spacing: -0.4599999785423279px;\n  text-align: center;\n"])));
...
var TG_ADS_ADMIN_API_URL = "https://tg-ads-test-two.vercel.app/api";
var TgAdsContainer = function (props) {
    ...
    var currentAdContent = React.useMemo(function () {
        ...
        if (currentAdData.adtype === "banner") {
            ...
            return (React__default["default"].createElement(BannerAd, { title: currentAdData.title, text: currentAdData.text, link: currentAdData.link, className: className, onClick: handleAdClick, onClose: handleAdClose, imageLink: currentAdData.iconLink, onError: handleError }));
        }
        if (typeof window !== "undefined") {
            var body = {
                platform: window.location.origin,
        ...
        return (React__default["default"].createElement(FullScreenAd, { onMute: handleAdMute, onClick: handleAdClick, link: currentAdData.link, onClose: handleAdClose, videoLink: currentAdData.videoLink, onError: handleError, onPlayStart: onPlayStart, onPlayEnd: onPlayEnd }));
    }, [currentAdData, type]);
